...
namespace NGMemory
{
    public class VAMemory
    {
        ...
        public bool CheckProcess()
        {
            ...
            ShowMessage("Programmer, define process name first!", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            return false;
        }
        ...
        {
            ShowMessage(processName + " is not running or has not been found. Please check and try again", "Process Not Found", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
    }
}